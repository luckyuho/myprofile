          ...
          <table className="table table-borderless">
            ...
            <tbody data-aos="fade-up">
              <tr>
                <th scope="row">
                  <p>
                    2021 - <b className="text-dark">Present</b>
                  </p>
                </th>
                <td>
                  <h6>PhD student / 國立成功大學航太所控制組</h6>
                  <p className="text-justify">
            ...
            <tbody data-aos="fade-up">
              <tr>
                ...
                <td>
                  <h6>master's degree / 國立成功大學航太所控制組</h6>
                  <p className="text-justify">
                    ...
                    <a
                      ...
                      className="text-success"
                    >
                      IEEE的一篇paper: Combination of computer vision detection
                      and segmentation for autonomous driving
                    </a>
            ...
            <tbody data-aos="fade-up">
              <tr>
                ...
                <td>
                  <h6>bachelor's degree / 國立成功大學航太系</h6>
                  <p className="text-justify">
            ...
            <tbody data-aos="fade-up">
              <tr>
                ...
                <td>
                  <p className="text-justify">
                    Solidity, Truffle, Html, Css, Javascript, React, Git,
                    Mongodb, Node.js Python, C++, Unity3D, Matlab, Linux,
            ...
            <tbody data-aos="fade-up">
              <tr>
                <th scope="row">
                  <p className="text-dark">Knowledge</p>
                </th>
                <td>
                  <p className="text-justify">
