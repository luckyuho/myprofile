        ...
        <div className="row">
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">募資平台 - 區塊鏈</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">獎金池 - 區塊鏈</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">猜拳遊戲 - 區塊鏈</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">個人網頁設計 - 前端設計</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">MERN - 前端＆後端設計</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">圖片庫 - 前端設計</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">TodoList - 前端設計</h5>
          ...
          <section className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">基礎網頁設計 - 前端設計</h5>
          ...
          <section id="owl3dproject" className="col-lg-4 col-12 mb-5 mb-lg-0">
            <div className="news-thumb" data-aos="fade-up">
              ...
              <div className="news-text-info">
                <h5 className="news-title">Kotlin App - 前端設計</h5>
